...
// ===== 단어장 (Vocab) Tab =====
(function () {
    const dropZone = document.getElementById('vocab-drop-zone');
    const fileInput = document.getElementById('vocab-file-input');
    const fileList = document.getElementById('vocab-file-list');
    const extractBtn = document.getElementById('vocab-extract-btn');
    const uploadSection = document.getElementById('vocab-upload-section');
    const loadingSection = document.getElementById('vocab-loading-section');
    const resultSection = document.getElementById('vocab-result-section');
    const downloadSection = document.getElementById('vocab-download-section');
    const resultBody = document.getElementById('vocab-result-body');
    const wordCount = document.getElementById('vocab-word-count');
    const generateBtn = document.getElementById('vocab-generate-btn');
    const addRowBtn = document.getElementById('vocab-add-row-btn');
    const downloadLink = document.getElementById('vocab-download-link');
